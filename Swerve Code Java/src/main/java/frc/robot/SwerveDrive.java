...
class final swerve
{
private SwerveModule modules[4];
modules[0] = new SwerveModule(11, 31, 21, new Vector(-17.75, 25));
modules[1] = new SwerveModule(12, 32, 22, new Vector(-17.75, -25));
modules[2] = new SwerveModule(13, 33, 23, new Vector(17.75, 25));
modules[3] = new SwerveModule(14, 34, 24, new Vector(17.75, -25));
